...
//        let t = JsonManager.shared.load()
//        print("*************POSITION*****************")
//        for i in 0..<t.count {
//            print(t[i].verticalPosition)
//        }
//        print("*************SPEED*****************")
//        for i in 0..<t.count {
//            print(t[i].verticalSpeed)
//        }
//        print("*************ACCELERATION*****************")
//        for i in 0..<t.count {
//            print(t[i].verticalAcceleration)
//        }
        var model = test1_1()
        
        do{
            try print(model.prediction(input: test1_1Input(verticalAcceleration: 1000, verticalSpeed: -52.77778244018555, verticalPosition: 371.5765686035156)).verticalFuturePosition)
        } catch {
            print("error")
        }
